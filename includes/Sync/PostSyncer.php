...
class PostSyncer {
    ...
    private function findExistingPost(string $source_id): ?int {
        ...
        $query = new \WP_Query([
            ...
            'post_status'    => 'any',
            'posts_per_page' => 1,
            // phpcs:ignore WordPress.DB.SlowDBQuery.slow_db_query_meta_query -- lookup by unique meta_key (_scps_source_id) covered by WordPress native postmeta index on meta_key
            'meta_query'     => [
                [
